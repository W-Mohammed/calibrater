...
## Chapter 3 plots:----
### 1. Case study 6 (identical to case 3): One target - two parameters:----
#### Saving path:----
path = "../5. Presentations/Cohort 8/CR_data/"
case_study_dir <- "Case_study_6/"
chapter_dir <- "Chap_3/"
image_dir <- "images/"
data_dir <- "data/"
...
parameters_list <- calibR::CR_CRS_data_1t$l_params
targets_list <- calibR::CR_CRS_data_1t$l_targets
interventions_list <- calibR::CR_CRS_data_1t$l_intervs
gof_measure <- "LLK"
sample_method <- "RGS"
...
CR_CRS_2P1T$draw_GOF_measure(
  ...
  .saving_image_height_ = 600)
##### Plot targets:----
CR_CRS_2P1T$draw_targets_plots(
  .sim_targets_ = TRUE,
  .save_ = TRUE,
  .saving_path_ = image_saving_path,
...
CR_CRS_2P1T$draw_distributions_plots(
  .save_ = TRUE,
  .saving_path_ = image_saving_path,
