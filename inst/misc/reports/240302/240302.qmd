...
n_observed <- 100
L <- matrix(rep(c(2, 0), n_observed), nrow=n_observed, byrow=TRUE) # Transformation matrix L for n observations
s_N_squared <- 2 # Variance of the measurement error, assuming identical for all observations
y <- rnorm(n_observed, 0, sqrt(s_N_squared)) # Example: n observed values generated around 2 with noise
