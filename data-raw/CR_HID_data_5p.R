# HID Model calibration data - Five parameters ("mu_e", "mu_l", "mu_t", "p", "r_l")
...
v_params_dists <- c('mu_e' = "unif", 'mu_l' = "unif", 'mu_t' = "unif",
                    'p' = "unif", 'r_l' = "unif")
v_params_dists2 <- c("lnorm", "lnorm", "lnorm", "lnorm", "lnorm")
...
CR_HID_data_5p <- list('l_params' = l_params,
                    'l_targets' = l_targets)
## Save calibration data internally:----
usethis::use_data(CR_HID_data_5p, overwrite = TRUE)
